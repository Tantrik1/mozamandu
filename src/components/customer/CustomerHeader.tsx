    ...
    return (
      ...
      >
        ...
        {openMegaMenu === category.id && (
          <div className="absolute top-full left-0 right-0 mx-auto w-full max-w-6xl px-4 bg-white shadow-2xl border-t-4 border-red-500 z-50opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300">
            <div className="p-8">
              <div className="mb-6">
