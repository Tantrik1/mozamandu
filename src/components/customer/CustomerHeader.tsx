    ...
    return (
      ...
      >
        ...
        {openMegaMenu === category.id && (
          <div className="fixed left-1/2 transform -translate-x-1/2 top-12 w-full max-w-4xl bg-white shadow-2xl border-t-4 border-red-500 z-50 transition-all duration-300
