    ...
    return (
      ...
      >
        ...
        {openMegaMenu === category.id && (
          <div className="fixed left-1/2 transform -translate-x-1/2 top-16 w-full max-w-4xl bg-white shadow-2xl border-t-4 border-red-500 z-50 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
            <div className="p-8">
              <div className="mb-6">
