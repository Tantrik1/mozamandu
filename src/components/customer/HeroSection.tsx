...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 sm:px-10 max-w-3xl mx-auto py-10 sm:py-14 bg-background/30 backdrop-blur-md rounded-2xl border border-white/20 shadow-xl shadow-black/5">
        {/* H1 - CSS animated entrance */}
        <h1 
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-3 sm:mb-4 leading-tight tracking-tight animate-fade-in"
        >
          Step Into Comfort
        </h1>
        ...
        <p 
          className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 max-w-xl mx-auto leading-relaxed animate-fade-in"
