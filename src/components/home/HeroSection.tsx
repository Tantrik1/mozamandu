...
export const HeroSection = memo(function HeroSection() {
  return <section className="relative min-h-[90vh] overflow-hidden bg-gradient-to-br from-background via-muted/50 to-primary/5">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 lg:pt-32 lg:pb-24 py-[66px]">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button asChild size="lg" className="rounded-full px-8 py-6 text-base font-semibold shadow-lg hover:shadow-xl transition-all group">
                <Link to="/shop">
                  Shop Now
