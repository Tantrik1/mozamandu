            ...
            >
              {saving ? (
                ...
                <>
                  ...
                  <span className="hidden sm:inline">Save Variants & Inventory</span>
              ...
              <Card className="shadow-sm border-border/80 overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-primary/5 via-primary/2 to-transparent border-b border-border/60 py-3 sm:py-4 px-4 sm:px-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <CardTitle className="text-sm sm:text-base font-semibold">General Information</CardTitle>
                      <CardDescription className="text-[11px] sm:text-xs">Product title, description, and fabric specs</CardDescription>
                    </div>
                  </div>
                </CardHeader>
