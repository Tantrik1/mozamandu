...
export function CreateProductForm({ onSave, onCancel }: CreateProductFormProps) {
  ...
  const form = useForm<z.infer<typeof productSchema>>({
    ...
    defaultValues: {
      ...
      status: 'active',
      material_composition: '100% Combed Cotton blend designed for daily comfort and breathability.',
  ...
  const saveVariantsToDatabase = async (productId: string) => {
    try {
    ...
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950/50 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8">
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <CardHeader className="bg-gradient-to-r from-primary/5 via-primary/2 to-transparent border-b border-border/60 py-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-xs">Title, description, and material details</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                ...
                <CardHeader className="bg-gradient-to-r from-emerald-500/5 via-transparent to-transparent border-b border-border/60 py-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-xs">Set financial parameters and taxonomy</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="p-6 space-y-6">
              ...
              <Card className="shadow-sm border-border/80 overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-blue-500/5 via-transparent to-transparent border-b border-border/60 py-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <CardTitle className="text-base font-semibold">Main Media Asset</CardTitle>
                      <CardDescription className="text-xs">High-efficiency WebP image</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                ...
                <CardHeader className="bg-gradient-to-r from-purple-500/5 via-transparent to-transparent border-b border-border/60 py-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-xs">Publish status and variant toggles</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="p-6 space-y-5">
              ...
              <CardHeader className="bg-gradient-to-r from-blue-600/10 via-indigo-500/5 to-transparent border-b border-border/60 py-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-xs">Configure color swatches, size grids, and variant images</CardDescription>
                  </div>
                </div>
              </CardHeader>
          ...
          {/* SEO Settings Section (Below Variants) */}
          <ProductSEOSection
