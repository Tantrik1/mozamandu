...
export function PaymentScreenshotViewer({ 
  imageUrl, 
  orderNumber, 
  customerName, 
  uploadedAt 
}: PaymentScreenshotViewerProps) {
          ...
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p><strong>Status:</strong> <Badge variant="outline" className="text-green-600">Verified</Badge></p>
              </div>
            </div>
          </div>
        </DialogContent>
